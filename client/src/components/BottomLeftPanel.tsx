...
export const BottomLeftPanel = track(
  ({
    isOpen,
    setIsOpen,
  }: {
    ...
    useEffect(() => {
      ...
      return () => {
        editor.off('event', handleGlobalEvent)
      }
    }, [editor, setIsOpen])
    ...
    return (
      <>
        ...
        <div
          style={{
            position: 'absolute',
            top: 72, // 🔺 原来是 12，抬高，避免盖住顶部标题
            bottom: 20, // 🔺 原来是 12，给底部留一些呼吸空间
            left: 20, // 🔺 稍微往右一点，与工具栏间距一致
            width: 240,
            background: 'white',
            borderRadius: 24,
